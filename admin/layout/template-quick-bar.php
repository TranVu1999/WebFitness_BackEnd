                            ...
                            <div class="tab-content">
                                    ...
                                    <ul class="ms-scrollable ms-quickbar-container">
                                        ...
                                        <li class="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                            <div class="ms-chat-status ms-status-offline ms-chat-img mr-3 align-self-center">
                                                <img src="public/img/dashboard/rakhan-potik-4.jpg" class="ms-img-round" alt="people">
                                            </div>
                                        ...
                                        <li class="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                            <div class="ms-chat-status ms-status-busy ms-chat-img mr-3 align-self-center">
                                                <img src="public/img/dashboard/rakhan-potik-5.jpg" class="ms-img-round" alt="people">
                                            </div>
                                            <div class="media-body ms-chat-user-info mt-1">
                                    ...
                                    <ul class="ms-scrollable ms-quickbar-container">
                                        <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                            ...
                                            <div class="media-body ms-chat-user-info mt-1">
                                                ...
                                                <ul class="ms-group-members clearfix mt-3 mb-0">
                                                    <li> <img src="public/img/dashboard/rakhan-potik-1.jpg" alt="member"> </li>
                                                    <li> <img src="public/img/dashboard/rakhan-potik-2.jpg" alt="member"> </li>
                                                    <li> <img src="public/img/dashboard/rakhan-potik-3.jpg" alt="member"> </li>
                                        ...
                                        <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                            ...
                                            <div class="media-body ms-chat-user-info mt-1">
                                                ...
                                                <ul class="ms-group-members clearfix mt-3 mb-0">
                                                    <li> <img src="public/img/dashboard/rakhan-potik-3.jpg" alt="member"> </li>
                                                    <li> <img src="public/img/dashboard/rakhan-potik-4.jpg" alt="member"> </li>
                                                </ul>
                                            </div>
                                        </li>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="contacts">
                                    <ul class="ms-scrollable ms-quickbar-container">
                                        ...
                                        <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                            <div class="ms-chat-img mr-3 align-self-center">
                                                <img src="public/img/dashboard/rakhan-potik-7.jpg" class="ms-img-round" alt="people">
                                            </div>
                                            <div class="media-body ms-chat-user-info mt-1">
                                        ...
                                        <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                            <div class="ms-chat-img mr-3 align-self-center">
                                                <img src="public/img/dashboard/rakhan-potik-8.jpg" class="ms-img-round" alt="people">
                                            </div>
                                            <div class="media-body ms-chat-user-info mt-1">
                        ...
                        <div class="ms-card ms-qa-card ms-deletable">
                            ...
                            <div class="ms-card-body">
                                ...
                                <ul class="ms-note-members clearfix mb-0">
                                    <li class="ms-deletable"> <img src="public/img/dashboard/rakhan-potik-2.jpg" alt="member"> </li>
                                    <li class="ms-deletable"> <img src="public/img/dashboard/rakhan-potik-3.jpg" alt="member"> </li>
                                </ul>
                            </div>
