                        ...
                        <div class="ms-panel-header">
                            <div class="d-flex-between-center">
                                ...
                                <div class="btn-control">
                                    <a href="product-delete.html" class="btn btn-danger has-icon mr-3"><i class="far fa-trash-alt"></i>Remove Banner</a>
                                    <a href="banner-add.html" class="btn btn-primary has-icon"><i class="far fa-plus-square"></i> Add Banner</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <ul class="lst-banner">
                                <li>
                                    <div class="banner-thumb">
                                        <div class="thumb-img">
                                            <img src="public/img/banners/banner1.jpg" alt="">
                                        </div>
                                        <div class="banner-info">
                                            ...
                                            <h2 class="pos-page">Header Home Page</h2>

                                            <ul class="banner-control">
                                                <li>
                                                    <button type="button" name="button" class="btn-transparent btn-bn-control btn-trash trigger-swal" data-swal="multi-step">
                                ...
                                <li>
                                    <div class="banner-thumb">
                                        <div class="thumb-img">
                                            <img src="public/img/banners/banner2.jpg" alt="">
                                        </div>
                                        <div class="banner-info">
                                            <span class="border-bn border-top-bn"></span>
                                            <span class="border-bn border-right-bn"></span>
                                ...
                                <li>
                                    <div class="banner-thumb">
                                        <div class="thumb-img">
                                            <img src="public/img/banners/banner3.png" alt="">
                                        </div>
                                        <div class="banner-info">
                                            <span class="border-bn border-top-bn"></span>
                                            <span class="border-bn border-right-bn"></span>
                                ...
                                <li>
                                    <div class="banner-thumb">
                                        <div class="thumb-img">
                                            <img src="public/img/banners/banner4.jpg" alt="">
                                        </div>
                                        <div class="banner-info">
                                            <span class="border-bn border-top-bn"></span>
                                            <span class="border-bn border-right-bn"></span>
