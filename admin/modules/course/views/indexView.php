                ...
                <div class="col-md-12">
                    <div class="ms-panel">
                        ...
                        <div class="ms-panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="#" id="chapter-title" method="post">
                                        <div class="form-row">
                                            <div class="col-12">
                                                <div class="input-group">
                                                    <input type="text" class="form-control mr-2" required="" placeholder="Add chapter title">
                                                    <button type="submit" class="btn btn-outline-primary btn-chapter-title">Add Chapter Title</button>
                                                </div>
                                                <div id="notify_chapter_title"></div>
                                            </div>
                                        </div>
                                    </form>
                                </div>
