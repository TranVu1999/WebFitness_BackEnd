                ...
                <div class="col-md-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb pl-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Cancel Customer List</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-12">
                    <div class="ms-panel">
                        <div class="ms-panel-header">
                            <h6>Cancel Customer List</h6>
                        </div>
                        <div class="ms-panel-body">
                            <div class="table-responsive">
                                <table id="data-delete-customer" class="table table-striped thead-primary w-100">
                                    <tbody>
                                        <tr>
                                            <td>101</td>
                                            <td>
