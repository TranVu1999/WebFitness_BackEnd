<?php
//echo "<pre>";
//print_r($data_prod_cate);
//print_r($data_lst_banner_of_prod_cate);
//echo "</pre>";
?>
...
<html lang="en">
    <head>
        ...
        <title>Admin - Product Category Detail</title>
        <!-- Iconic Fonts -->
    ...
    <body class="ms-body ms-aside-left-open ms-primary-theme ">
            ...
            <div class="ms-content-wrapper">
                <div class="row">
                                ...
                                <div id="slide">
                                    ...
                                    <div id="slide-item">
                                        <ul>
                                            ...
                                            if( count($data_lst_banner_of_prod_cate) < 4){
                                                for ($i; $i < 4; $i++) {
                                                    if ($i == 0) {
                                                        ?>
                                                        <li class="active">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <script>
                                                document.getElementById('product-cate-desc').value = '<?= $data_prod_cate['ProductCateDesc'] ?>';
                                            </script>
                                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="ms-panel">
                            <div class="ms-panel-header">
                                <h2>Product Category Infomation</h2>
                            </div>
                            <div class="ms-panel-body">
                                <div class="row">
                                    <div class="col-4">
                                        <span>Amount Product: <?= $data_prod_cate['amount_product'] ?></span>
                                    </div>
                                    <div class="col-4">
                                        <span>Created Date: <?= $data_prod_cate['CreatedDate'] ?></span>
                                    </div>
                                    <div class="col-4">
                                        <span>Last Modified Date: <?= $data_prod_cate['ModifiedDate'] ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script src="public/js/setting_detail_prodCate.js"></script>
